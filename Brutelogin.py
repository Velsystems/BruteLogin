...
while(angka<1):
    run()
    mengetik(D+'\n  ADMIN LOGIN SCANNER & Bug Website scan')
    mengetik(C+"  Re; Velsystem")
    mengetik(G+"  Team: Desepticon Pirate Cyber")
    mengetik(I+"  Thanks for all Member DPCA")
    mengetik(I+"  Ketik Website Kalian Tanpa http:// !!")
